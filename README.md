...
8. Transductive Learning using Graphs: [assignment][a08_ass], solution.
...
* [Youtube Fame Predictor](project/proposals/youtube_fame.pdf), Benoît Steinmann, Cyrille Rolland
...
* [Alzheimer Disease Detection](project/proposals/alzheimer_detection.pdf), Christian Abbet, Maxime Bonhenblust, Nicolas Masserey
